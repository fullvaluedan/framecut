...
| `apps/web/src/effects/components/assets-view.tsx` | Effects panel gains "HyperFrames assets" browser section (templates + official registry with checkbox prefs; section in `features/ai-generate/hf-assets-section.tsx`, ours) | 2026-06-12 | One mount line |

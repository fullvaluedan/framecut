...
| `apps/web/src/components/editor/scenes-view.tsx` | "Nest" button per scene row (renders scene → clip at playhead via `features/editing/nest-scene`) | 2026-06-11 | UI hook only |
